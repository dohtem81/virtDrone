...
public:
    SimulationApp()
        : quad_(drone::model::Quadrocopter::createWithBatterySim(
              ...
              drone::model::components::AltitudeController(1.0, 1.0, 20000.0, 10.00, 33000.0)
              )),
          elapsed_s_(0.0) {}
...
protected:
    void onStart() override {
        ...
        quad_.getAltitudeController()->setTargetAltitude(20.0); // Set target altitude to 10 meters
        altitude_m_ = 0.0;
    ...
    void onStep(double dt_s) override {
        ...
        double kv = 1.0;  // Vertical drag coefficient, adjustable
